...
export const mockRoles: { key: RoleKey; name: string; description: string; permissions: PermissionKey[] }[] = [
  {
    ...
    permissions: ['menu.dashboard', 'menu.exchange', 'menu.positions', 'menu.orders', 'menu.assets', 'menu.trades', 'menu.research', 'menu.research', 'menu.news', 'menu.users', 'orders.detail', 'orders.cancel', 'assets.view', 'assets.freeze', 'trades.export', 'users.view', 'users.create', 'users.edit', 'users.disable', 'roles.assign', 'exchange.placeOrder', 'positions.view', 'positions.close', 'positions.risk', 'research.view', 'research.download', 'research.bookmark', 'news.view', 'news.bookmark', 'news.markRead'],
  },
  {
    key: 'risk_manager',
    name: '风控经理',
    description: '关注订单、成交和风险处置，可查看用户但不可分配角色。',
    permissions: ['menu.dashboard', 'menu.exchange', 'menu.positions', 'menu.orders', 'menu.trades', 'menu.research', 'menu.news', 'menu.users', 'orders.detail', 'orders.cancel', 'trades.export', 'users.view', 'exchange.placeOrder', 'positions.view', 'positions.close', 'positions.risk', 'research.view', 'research.download', 'research.bookmark', 'news.view', 'news.bookmark', 'news.markRead'],
  },
  {
    key: 'finance_operator',
    name: '财务运营',
    description: '负责资产核对与资金冻结，不进入用户管理。',
    permissions: ['menu.dashboard', 'menu.positions', 'menu.assets', 'menu.trades', 'menu.research', 'menu.news', 'assets.view', 'assets.freeze', 'positions.view', 'research.view', 'news.view'],
  },
  {
    key: 'auditor',
    name: '审计员',
